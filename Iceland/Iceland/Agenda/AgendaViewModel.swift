...
public protocol AgendaViewModelDelegate: class {
    ...
    func reschedule(to: Date, includeTime: Bool, url: URL, headingLocation: Int, complete: @escaping () -> Void, failure: @escaping (Error) -> Void)
    func changeDue(to: Date, includeTime: Bool, url: URL, headingLocation: Int, complete: @escaping () -> Void, failure: @escaping (Error) -> Void)
