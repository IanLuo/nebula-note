...
public protocol PageViewModelDelegate: class {
    func didLoadDocument(text: String)
}

public class PageViewModel {
    internal let pageController: PageController
    internal weak var delegate: PageViewModelDelegate?
...
"""
    ...
    public init(pageController: PageController) {
        self.pageController = pageController
    }
    
    public func loadDocument() {
        self.delegate?.didLoadDocument(text: text)
    }
}
